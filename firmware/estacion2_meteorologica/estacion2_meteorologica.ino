/*
 * ================================================================
 *  ESTACIÓN METEOROLÓGICA REMOTA — ESP32  |  ESTACIÓN 2
...
const char* mqtt_user     = "Estacion2";
const char* mqtt_pass     = "Estacion2123@";
const char* topic_sub     = "estacion2/solicitud";
const char* topic_pub     = "estacion2/datos";
const char* topic_comando = "estacion2/comando";
const char* topic_estado  = "estacion2/estado";
const char* mqtt_clientId = "ESP32_Estacion_Remota22";
...
void setup() {
  Serial.begin(115200);
  delay(500);
  Serial.println("\n=== ESTACION METEOROLOGICA REMOTA 2 ===");
